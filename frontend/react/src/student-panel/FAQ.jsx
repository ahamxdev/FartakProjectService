...
const TicketFAQComponent = () => {
  ...
  const toggleItem = (key) => {
    if (activeItems.includes(key)) {
      ...
      setActiveItems([...activeItems, key]);
    }
  };
  ...
  return (
    <main className="p-4 flex flex-col h-full">
      <div className="flex flex-grow">
        <div className="text-center mt-4 flex flex-col w-full" style={{ height: "100%" }}>
          <div className="flex flex-col h-full">
            <h2 className="mb-4 text-2xl">سوالات متداول</h2>
            <p className="mb-6">هزاران کاربر نمی‌توانند اشتباه کنند</p>
            ...
            <div
              ...
              dir="rtl"
              style={{ flex: "1 1 auto", minHeight: "400px" }}
            >
              <div className="rounded-lg border-0 shadow-sm mb-3 overflow-hidden">
                <div
                  className="py-3 bg-gray-100 flex justify-between px-2 items-center cursor-pointer"
                ...
                >
                  ...
                  {activeItems.includes("0") ? (
                    <img src="/img/up-arrow.png" alt="" className="w-5 h-5" />
                  ) : (
                    <img src="/img/down-arrow.png" alt="" className="w-5 h-5" />
                  )}
                </div>
                <div
                  className={`${activeItems.includes("0") ? "block" : "hidden"} p-4 bg-white`}
                >
                  <div className="text-right">توضیحی درباره هدف...</div>
                </div>
              </div>
              <div className="rounded-lg border-0 shadow-sm mb-3 overflow-hidden">
                <div
                ...
                <div
                  className={`${activeItems.includes("1") ? "block" : "hidden"} p-4 bg-white`}
                >
              ...
              <div className="rounded-lg border-0 shadow-sm overflow-hidden">
                ...
                <div
                  className={`${activeItems.includes("2") ? "block" : "hidden"} p-4 bg-white`}
                >
                  <div className="text-right">
                    توضیحاتی درباره تمایز...
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="w-full border rounded-xl shadow-sm py-4 mt-auto">

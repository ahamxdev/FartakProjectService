      ...
      <div className="d-flex flex-grow-1">
        ...
        <main className="flex-grow-1 p-4 d-flex flex-column">
          <div className="row flex-grow-1">
            <div
              className="text-center mt-4 d-flex flex-column"
              style={{ height: "100%" }}
            >
              <div>
                <h2 className="mb-4">سوالات متداول</h2>
                <p>هزاران کاربر نمی‌توانند اشتباه کنند</p>

                <div className="d-flex justify-content-center mb-4">
                  <button
                    className={`btn mx-2 rounded-pill px-4 ${
                      activeButton === "support"
                        ? "bg-info text-white"
                        : "bg-white border border-info text-info"
                    }`}
                ...
                <div
                  className="accordion mx-auto w-75"
                  id="faqAccordion"
                  dir="rtl"
                  style={{ flex: "1 1 auto", minHeight: "400px" }}
                >
                  <div className="card rounded-3 border-0 shadow-sm mb-3">
                    <div
                      className="card-header py-3 bg-Secondary d-flex justify-content-between align-items-center"
          ...
          <div className="container-fluid border rounded-3 shadow-sm py-4 mt-auto">

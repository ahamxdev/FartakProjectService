          ...
          <div className="container-fluid">
            <div className="row g-4">
              <div className="col-lg-6">
                <div className="border rounded-3 p-4 shadow h-100">
                  <h3 className="fw-bold mb-4">ارسال تیکت پشتیبانی</h3>
                  <form>
                    <div className="mb-3">
                    ...
                    <div className="row mb-3">
                      <div className="col-md-6 mb-3">
                        <label className="form-label">گروه پیام:</label>
                    ...
                    <div className="row mb-3">
                      <div className="col-md-6 mb-3">
                        <label className="form-label">زیر موضوع پیام:</label>
                        <input
                          type="text"
              ...
              <div className="col-lg-6">
                <div className="border rounded-3 p-4 shadow h-100">
                  <h3 className="text-center mb-4">وضعیت تیکت های پشتیبانی</h3>
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="text-warning fw-bold">منتظر پاسخ</td>
                        </tr>
                        <tr>
                          <td>2fd4</td>
                          <td>
                  ...
                  <div className="text-center mt-4">
                    <button className="btn btn-dark">نمایش کامل تیکت ها</button>
                  </div>
                </div>
              </div>
            </div>
            <div className="container-fluid border rounded-3 shadow-sm py-4 mt-3">

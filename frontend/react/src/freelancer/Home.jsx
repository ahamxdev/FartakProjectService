...
const Dashboard = () => {
  return (
   ...
   <button> ورود | عضویت</button> 
    ...
    <Link className="header-bottom-link"  href="#">خانه</Link>
    <Link className="header-bottom-link" href="#">تدریس</Link>
    <Link className="header-bottom-link" href="#">پروژه ها</Link>
    <Link className="header-bottom-link" href="#">
    دوره ها
      </Link>
    <Link className="header-bottom-link" href="#">وبلاگ</Link>
    <Link className="header-bottom-link" href="#">درباره ما</Link>
    <Link className="header-bottom-link" href="#">تماس با ما</Link>
    <Link className="header-bottom-link" href="#">پشتیبانی</Link>
    </div>
   </div> 

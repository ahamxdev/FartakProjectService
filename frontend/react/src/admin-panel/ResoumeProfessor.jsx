                    ...
                    <div className="accordion" id="accordionExample" style={{width: "100%"}}>
                        ...
                        <div className="accordion-item">
                                ...
                                <button className="accordion-button collapsed btn-img" type="button" data-bs-toggle="collapse"
                                    ...
                                    <div className="title-accordion-rows">
                                        <div className="title-accordion-row">
                                            <p style={{fontWeight:"600"}}>  محمد ایمانی در انتظار تایید رزومه  </p>
                                        </div>

                                        <div className="title-accordion-row">
                                           <button style={{backgroundColor:"rgba(41, 172, 149, 1)"}}>تایید</button>
                                           <button style={{backgroundColor:"rgba(198, 48, 62, 1)"}}>لغو</button>
                                        </div>
                            ...
                            <div className="accordion-collapse collapse" aria-labelledby="headingHoo"
                                ...
                                <p style={{fontWeight:"700",paddingRight:"15px"}}>درباره من</p>
                                <p style={{paddingRight:"15px"}}>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.</p>
                                <p  style={{fontWeight:"700",paddingRight:"15px"}}>اطلاعات علمی رزومه</p>
                                ...
                                <div className="resome-info">
                                    ...
                                    <p style={{fontWeight:"700",paddingRight:"15px"}}>سوابق تحصیلی</p>
                                    <div className="resome-info">
                                ...
                                <p style={{fontWeight:"700",paddingRight:"15px"}}>مسلط به دروس و زبان های </p>
                                                <div className="lesson-languaghe">
                                                    <button>bootstrap</button>
                                                    <button>مهندسی نرم افزار - کارشناسی ناپیوسته حرفه ای نرم افزار</button>
                                                    <button>آزمایشگاه مهندسی نرم افزار - کارشناسی ناپیوسته حرفه ای نرم افزار</button>

                                                </div>

                                                <div className="lesson-languaghe" style={{marginRight:"1rem",marginTop:"20px"}}>
                                                    
                                                    <button>مهندسی نرم افزار - کارشناسی ناپیوسته حرفه ای نرم افزار</button>
                                                    <button>آزمایشگاه مهندسی نرم افزار - کارشناسی ناپیوسته حرفه ای نرم افزار</button>

                                                </div>
                                <p style={{fontWeight:"700",paddingRight:"15px",marginTop:"35px"}}>مسلط به دروس و زبان های </p>
                                <p style={{paddingRight:"15px"}}>معلم کامپیوتر در هنرستان از سال 1399 تا سال 1400</p>
                                <p style={{paddingRight:"15px"}}>معلم کامپیوتر در هنرستان از سال 1399 تا سال 1400</p>

                                <p style={{fontWeight:"700",paddingRight:"15px",marginTop:"35px"}}>  بارگذاری ویدیو معرفی </p>
                                <p style={{paddingRight:"15px"}}>عنوان ویدیو : درباره من</p>
                                <p style={{paddingRight:"15px"}}>مدت زمان ویدیو:  دقیقه</p>
                                <p style={{paddingRight:"15px"}}>معلم کامپیوتر در هنرستان از سال 1399 تا سال 1400</p>
                                    
                                   
                                    <video className="video-resome-professor" src="#" controls></video>
                            </div>
                        </div>
                        ...
                        <div className="accordion-item">
                            ...
                            <button className="accordion-button collapsed btn-img" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseHay" aria-expanded="false" aria-controls="collapseHay">
                                    <div className="title-accordion-rows">
                                        <div className="title-accordion-row">
                                            <p style={{fontWeight:"600"}}>  محمد ایمانی در انتظار تایید رزومه  </p>
                                        </div>
                            ...
                            <div className="accordion-collapse collapse" aria-labelledby="headingHay"
                                 data-bs-parent="#accordionExample"
                                 id="collapseHay">

	...
	return (
		<div className="my-10">
			...
			<div className="flex mt-[79px] px-5 justify-between w-full">
				<div className="bg-[#FFE401] basis-[47%] rounded-[4px] sm:gap-5 sm:p-5 md:max-h-[148px] sm:rounded-[20px] sm:flex sm:items-center sm:flex-row-reverse">
				...
				<div className="bg-[#FDF39A] basis-[47%] md:max-h-[148px] rounded-[4px] sm:gap-5 sm:p-5 sm:rounded-[20px] sm:flex sm:items-center sm:flex-row-reverse">

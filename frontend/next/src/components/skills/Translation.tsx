...
import TranslationCategory from '@/components/modules/TranslationCategory'
import SectionTitle from '@/components/modules/SectionTitle'
import QualityProjectBox from '@/components/modules/QualityProjectBox'
...
import ChooseTranslationLanguageBox from '@/components/modules/ChooseTranslationLanguageBox'
      ...
      <section className='w-[90%] flex flex-col gap-4 mx-auto md:my-10 my-5 bg-[#EEF5FF] rounded-2xl border-[2px] border-[#1E1E1E] py-5 lg:py-10 px-4 sm:px-8 md:px-12 lg:px-16'>
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8 w-full">
          ...
          <div className="flex flex-col gap-3.5 w-full">
            <span className='font-bold md:text-[22px] text-sm text-[#000]'>زمان مبدا را انتخاب کنید</span>
          ...
          <div className="flex flex-col gap-3.5 w-full">
            <span className='font-bold md:text-[22px] text-sm text-[#000]'>زمان مقصد را انتخاب کنید</span>
            <div className="flex items-center gap-4">
              <button className='rounded-lg border-[2px] w-full border-[#1D40D7] px-3 py-1 flex justify-between items-center text-base bg-[#fff] font-normal cursor-pointer text-[#00000080]'>
                زمان مقصد
                <svg width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col gap-3.5 w-full">
            <span className='font-bold md:text-[22px] text-sm text-[#000]'>کیفیت ترجمه را انتخاب کنید</span>
            <div className="flex items-center gap-4">
              <button className='rounded-lg border-[2px] w-full border-[#1D40D7] px-3 py-1 flex justify-between items-center text-base bg-[#fff] font-normal cursor-pointer text-[#00000080]'>
                کیفیت
                <svg width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col gap-3.5 w-full">
            <span className='font-bold md:text-[22px] text-sm text-[#000]'>نوع ترجمه را انتخاب کنید</span>
            <div className="flex items-center gap-4">
              <button className='rounded-lg border-[2px] w-full border-[#1D40D7] px-3 py-1 flex justify-between items-center text-base bg-[#fff] font-normal cursor-pointer text-[#00000080]'>نوع
                <svg width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1 1.47852L6 5.47852L11 1.47852" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
          ...
          <div className="flex flex-col gap-3.5 w-full">
            ...
            <input type="number" className='rounded-lg border-[2px] border-[#1D40D7] bg-white py-1 px-4 placeholder:text[#aaa] placeholder:text-base placeholder:font-normal' placeholder='تعداد کلمات' />
          </div>
          <div className="flex flex-col gap-3.5 w-full">
            <span className='font-bold md:text-[22px] text-sm text-[#000]'>فایل خود را وارد کنید</span>
            <div className="flex items-center gap-4">
              <div onClick={() => {
                if (inputRef.current) {
        ...
        <div className="w-full flex flex-col gap-2">
          <label className='font-bold md:text-[22px] text-sm text-[#000]' htmlFor="">توضیحات خود را وارد بنویسید</label>
          <textarea className='w-full h-[100px] border-[2px] border-[#1D40D7] rounded-lg py-4 px-4 placeholder:text[#aaa] bg-white placeholder:text-base placeholder:font-normal' placeholder='توضیحات خود را وارد بنویسید'></textarea>
        </div>

...
const PortfolioBox = () => {
  return (
    <div
      className="p-4 rounded-[16px] bg-[#EEF5FF] flex flex-col gap-4 items-center"
      id="portfolio-box"
    >
      <div className="relative lg:w-[248px] w-[160px] lg:h-[248px] h-[160px]">
        <Image
          src={"/images/image 1300.png"}
          fill
      ...
      <Link
        href={"/projects/portfolio/10"}
        className="w-full bg-[#1D40D7] rounded-lg flex justify-center items-center py-2 text-white font-normal text-sm"
      >
        مشاهده جزئیات
      </Link>
    </div>

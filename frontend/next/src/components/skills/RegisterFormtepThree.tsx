...
const options = [
      "امکان تعریف زیرمحصول (بر اساس رنگ، اندازه و…)",
      "پیشنهاد های ویژه",
      "بخش اخبار و مقالات",
      "امکان تعریف زیرمحصول (بر اساس رنگ، اندازه و…)",
      "پیشنهاد های ویژه",
    ...
    <>
      <div className="px-10 py-6 flex flex-col gap-6 w-full">
        <span className="md:text-xl text-base font-bold text-[#000]">
          امکاناتی که می‌خواهید در سایت‌تان داشته باشید، انتخاب کنید. اگر
          امکانات اضافه ای می‌خواهید، در بخش توضیحات بنویسید.
        </span>

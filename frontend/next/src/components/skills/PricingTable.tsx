      ...
      return (
            <section className="w-[90%] mx-auto flex flex-col gap-8 md:my-10 my-5">
                  <div className="flex items-center justify-between gap-5 px-6 py-5 overflow-x-auto">
                        <button className="cursor-pointer flex-1 border-[1px] border-[#EEF5FF] rounded-md md:text-lg text-sm font-bold flex justify-center items-center px-6 py-5 outline-none">سایت کامل</button>
                        <button className="cursor-pointer flex-1 shadow-md bg-[#EEF5FF] rounded-md flex flex-col gap-2 justify-center items-center px-4 py-2 outline-none">
                        ...
                        <button className="cursor-pointer flex-1 shadow-md relative bg-[#495AFF] rounded-md flex flex-col gap-2 justify-center items-center px-4 py-2 outline-none">

...
const options = ["قالب آماده", "قالب اختصاصی", "نمیدانم"];

const options2 = ["وردپرس", "پرستا شاپ", "دروپال", "جوملا", "مجنتو", "نمیدانم"];
const options3 = [
  "بله",
  "خیر",
];
      ...
      <div className="px-10 py-6 flex flex-col gap-6">
        <div className="flex flex-col lg:flex-row justify-between items-center lg:gap-16 gap-8 w-full">
          <div className="flex flex-col gap-8 lg:w-[33%] w-full">
            ...
            <textarea
              className="h-[120px] rounded-lg border-[2px] p-3 placeholder:text-sm placeholder:text-[#787878] placeholder:font-normal bg-[#EEF5FF] border-[#1E1E1E]"
              placeholder="حوزه فعالیت سایت خود را بنویسید"
            ></textarea>
          </div>
        ...
        <div className="w-full flex flex-col gap-5">
          ...
          <textarea
            className="h-[70px] rounded-lg border-[2px] p-3 placeholder:text-sm placeholder:text-[#787878] placeholder:font-normal flex items-center bg-[#EEF5FF] border-[#1E1E1E]"
            placeholder="توضیحات سیستم مدیریت محتوای سایت خود را بنویسید"
          ></textarea>
        </div>
        <div className="w-full flex md:flex-row flex-col justify-between gap-5">
          <div className="flex flex-col gap-5">
            <span className="md:text-xl text-base font-bold text-[#000]">
              اپلیکیشن موبایل هم نیاز دارید؟
            </span>
            <div className="flex justify-between items-center gap-6">
              {options3.map((label) => (
                <InputCheckbox

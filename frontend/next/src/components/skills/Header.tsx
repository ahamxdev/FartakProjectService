...
const Header = () => {
      ...
      return (
            <>
                  <header className='w-full px-4 sticky top-0 z-10 mx-auto md:py-10 py-3 bg-white md:shadow-[0_2px_12px_0_rgba(0,0,0,0.1)]'>
                        <div className="flex items-center gap-2 w-full justify-between md:justify-baseline">
                              ...
                              <div className="flex flex-col md:grow gap-y-5">
                                    <div className="flex items-center justify-between">
                                          <h2 className='text-[32px] hidden md:block text-[#FAB437] font-extrabold'>فرتاک پروژه</h2>
                                          <div className="flex justify-between gap-6">
                                                ...
                                                <Link className='bg-[#1D40D7] text-white px-3 md:px-6 py-1 md:py-2 rounded-md text-[10px] flex justify-center items-center md:text-base font-normal' href={"/"}>ورود | عضویت</Link>
                                          </div>
                                    </div>
                                    <ul className='md:flex hidden items-center space-x-6 justify-center w-[90%] border-t-[1px] border-t-[#00000040] pt-6'>
                                          <li className='cursor-pointer'>
                                                <Link className='text-base font-bold text-[#00060F] hover:text-gray-300 transition-colors duration-100' href={"/"}>خانه</Link>
                                          </li>
                                          <li className='cursor-pointer'>
                                                <Link className='text-base font-bold text-[#00060F] hover:text-gray-300 transition-colors duration-100' href={"/"}>تدریس</Link>
                                          </li>
                                          <li className='cursor-pointer'>
                                                <Link className='text-base font-bold text-[#00060F] hover:text-gray-300 transition-colors duration-100' href={"/skills"}>پروژه ها</Link>
                                          </li>
                                          <li className='text-base font-bold cursor-pointer text-[#00060F] flex items-center gap-2'>
                                                <Link className='text-base font-bold text-[#00060F] hover:text-gray-300 transition-colors duration-100' href={"/skills"}>دوره ها</Link>                                                {/* <svg width="12" height="6" viewBox="0 0 12 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                      <path d="M1 0.839844L6 4.83984L11 0.839844" stroke="#00060F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg> */}
                                          </li>
                                          <li className='cursor-pointer'>
                                                <Link className='text-base font-bold text-[#00060F] hover:text-gray-300 transition-colors duration-100' href={"/"}>وبلاگ</Link>
                                          </li>
                                          <li className='cursor-pointer'>
                                                <Link className='text-base font-bold text-[#00060F] hover:text-gray-300 transition-colors duration-100' href={"/"}>درباره ما</Link>
                                          </li>
                                          <li className='cursor-pointer'>
                                                <Link className='text-base font-bold text-[#00060F] hover:text-gray-300 transition-colors duration-100' href={"/"}>تماس با ما</Link>
                                          </li>
                                          <li className='cursor-pointer'>
                                                <Link className='text-base font-bold text-[#00060F] hover:text-gray-300 transition-colors duration-100' href={"/"}>پشتیبانی</Link>
                                          </li>
                                    </ul>
                              </div>
                        </div>

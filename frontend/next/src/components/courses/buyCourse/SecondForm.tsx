		...
		<div className="flex w-full flex-col mt-10">
			...
			<div className="flex mt-3 flex-col">
				<Breadcrumbs
					...
					<div
						onClick={() => {
							if (educationBreadCrumbs.length)
								setEducationBreadCrumbs([]);
						}}
				...
				<div className="flex flex-col px-6 py-4">
					{currentEducationCategory &&
					!Array.isArray(currentEducationCategory)
						? Object.keys(currentEducationCategory)?.map(
								(item, index) => (
									<Fragment key={index}>
										<div
											onClick={() => {
										...
										{index !==
											Object.keys(currentEducationCategory).length -
												1 && <Divider color="#B1BFFA" />}
									</Fragment>
								),
						  )
				...
				<div className="flex flex-col px-6 py-4">
					{currentBussinesCategory &&
					!Array.isArray(currentBussinesCategory)

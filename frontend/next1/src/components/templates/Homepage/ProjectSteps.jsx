...
const ProjectSteps = () => {
      return (
            <div className='w-full bg-[#D5E8DB] my-6 flex lg:flex-row flex-col items-center justify-between px-5 py-4'>
                  ...
                  <Link className='bg-[#00C83F] lg:w-[22%] w-full md:text-sm text-xs font-normal text-white px-8 md:py-3 py-1.5 rounded-lg mt-3 md:mt-0 flex justify-center items-center' href={"/"}>همین حالا پروژه خود را سفارش دهید </Link>
            </div>
      )
}

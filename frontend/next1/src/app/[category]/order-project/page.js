                  ...
                  <div id='category-header' className='w-full relative md:h-[415px] h-[200px] my-4 pb-4 md:pb-0 md:pt-12 pt-3'>
                        <div className="absolute top-0 left-0 bottom-0 right-0">
                              <div className="relative w-full md:h-[415px] h-[200px]">
                                    <Image src={"/images/AI Generator (7).png"} fill
                                          sizes="100vw, auto"
                        ...
                        <div className="flex justify-center items-center lg:mt-[15%] mt-[16%] sm:mt-[40%] md:mt-[24%] relative z-10 flex-col gap-5">
                              <h1 className='font-bold md:text-4xl text-xl text-[#fff] flex justify-center items-end'>ثبت پروژه</h1>
                              <h3 className='font-bold md:text-4xl text-xl text-center text-[#fff] flex justify-center items-end'>با فرتاک ایده های خود را به واقعیت تبدیل کنید</h3>
                        </div>
                  </div>


                  <section className='w-[90%] mx-auto md:my-8 my-5 flex flex-col gap-10'>
                        <h6 className='text-[##00060F] font-bold md:text-3xl text-xl text-right'>ایجاد یک پروژه</h6>
                        <div className="flex md:flex-row flex-col justify-between md:gap-30 gap-5">
                              <div className="flex flex-col gap-4 md:w-[50%] w-full">
                                    <p className='text-[##00060F] md:text-xl text-base font-bold'>میخواهید چه کاری برای شما انجام شود ؟</p>
                                    <label className='text-[##00060F] text-sm font-normal' htmlFor="">
                                          سرویس مورد نظر خود را انتخاب کنید .
                                    </label>
                                    <div className="flex items-center gap-4 w-full">
                                          <button className={`rounded-lg border-[2px] border-[#DC3545] w-full px-3 py-2 flex justify-between items-center text-base bg-[#fff] font-normal cursor-pointer text-[#00000080]`}>
                                                دسته بندی
                              ...
                              <div className="flex flex-col gap-4 md:w-[50%] w-full">
                                    <p className='text-[##00060F] md:text-xl text-base font-bold'>یک عنوان خوب برای پروژه بنویسید .</p>
                                    <label className='text-[##00060F] text-sm font-normal' htmlFor="">
                                          عنوان پروژه
                                    </label>
                                    <div className="flex items-center gap-4 w-full">
                                          <input className={`rounded-lg border-[2px] border-[#DC3545] w-full px-3 py-2 flex justify-between items-center text-base bg-[#fff] font-normal cursor-pointer text-[#00000080]`} />
                                    </div>
                        ...
                        <div className="flex md:flex-row flex-col justify-between gap-5">
                              <div className="flex flex-col gap-4 md:w-[60%] w-full">
                                    <p className='text-[##00060F] md:text-xl text-base font-bold'>درباره پروژه توضیح دهید</p>
                                    <label className='text-[##00060F] text-sm font-normal' htmlFor="">
                                          هر چه توضیحات بیشتر و واضح‌تر باشد به شما کمک می‌کند سریعتر به آنچه می‌خواهید برسید
                                    </label>
                                    <div className="flex items-center gap-4 w-full">
                                          <textarea className={`rounded-lg border-[2px] h-[190px] border-[#DC3545] w-full px-3 py-2 flex justify-between items-center md:text-base bg-[#fff] font-normal cursor-pointer text-[#00000080] placeholder:text-[#aaa] text-sm`} placeholder='توضیحات تکمیلی'>
                                          </textarea>
                                    </div>
                              </div>
                              <div className="flex flex-col gap-4 md:w-[40%] w-full">
                                    <p className='text-[##00060F] md:text-xl text-base font-bold'>آپلود فایل</p>
                                    <label className='text-[##00060F] text-sm font-normal' htmlFor="">
                        ...
                        <div className="flex flex-col gap-4">
                              <div className="flex flex-col gap-4 w-full">
                                    <p className='text-[##00060F] md:text-xl text-base font-bold'>به چه مهارت‌هایی نیاز دارید؟</p>
                                    <label className='text-[##00060F] text-sm font-normal' htmlFor="">
                                    ...
                                    <div className="flex items-center gap-2 rounded-lg border-[1px] border-[#DC3545] px-6 py-2 justify-between">
                                          <span className='cursor-pointer'>
                                                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                      <path d="M9.24309 0.757865L0.757812 9.24315M9.24309 9.24309L0.757812 0.757812" stroke="#495AFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                                          </span>
                                          <span className='md:text-lg text-sm text-[#000] font-normal'>مهارت 1</span>
                                    </div>
                              </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-4">
                              <div className="flex flex-col gap-4 w-full">
                                    <p className='text-[##00060F] md:text-xl text-base font-bold'>اولویت و بودجه را مشخص کنید.</p>
                                    <label className='text-[##00060F] text-sm font-normal' htmlFor="">
                              ...
                              <div className="flex items-center gap-5 justify-between flex-wrap">
                                    <div className={`flex justify-center items-center rounded-lg border-[1px] border-[#DC3545] px-4 py-2`}>
                                          <div className='flex items-center gap-2'>
                                                ...
                                                <label className='text-base font-extrabold pb-1.5 text-[#000]'>
                                                      برای من <span className='text-[#495AFF]'>قیمت</span> بالاترین درجه اهمیت را دارد
                                                </label>
                                          </div>
                                    </div>
                                    <div className={`flex justify-center items-center rounded-lg border-[1px] border-[#DC3545] px-4 py-2`}>
                                          <div className='flex items-center gap-2'>
                                                ...
                                                <label className='text-base font-extrabold pb-1.5 text-[#000]'>
                                                      برای من <span className='text-[#495aff]'>کیفیت</span> بالاترین درجه اهمیت را دارد
                                                </label>
                                          </div>
                                    </div>
                                    <div className={`flex justify-center items-center rounded-lg border-[1px] border-[#DC3545] px-4 py-2`}>
                                          <div className='flex items-center gap-2'>
                                                ...
                                                <label className='text-base font-extrabold pb-1.5 text-[#000]'>
                                                      برای من ترکیبی از <span className='text-[#495aff]'>کیفیت</span> و <span className='text-[#495aff]'>قیمت</span> اهمیت را دارد
                                                </label>
                                          </div>
                                    </div>
                              </div>
                              <span className='md:text-base text-sm text-[##00060F] font-normal'>انتخاب بودجه (تومان)</span>
                              ...
                              <button className={`w-full flex justify-center items-center text-[#fff] rounded-lg bg-[#6C757D] py-3 md:text-lg text-sm font-bold cursor-pointer`}>
                                    ثبت رایگان پروژه
                              </button>
                        </div>
                  </section>
